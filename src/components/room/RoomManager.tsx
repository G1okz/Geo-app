            ...
            {activeTab === 'create' ? (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="appearance-none block w-full px-3 py-2 border border-white/20 rounded-md shadow-sm bg-white/10 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 sm:text-sm transition-colors duration-200 uppercase"
                      maxLength={6}
                    />
                  </div>
                </div>
                ...
                {joinedRooms.length > 0 && (
                  <div className="mt-6">
                    <h3 className="text-lg font-medium text-white mb-4">Salas a las que te has unido</h3>
                    <div className="space-y-3">
